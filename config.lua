...
Config.ScannerLocations = {
    {
        location = vec3(1834.1989, 2594.3523, 45.0144),
        heading = 94.7019,
        hideObject = true, -- Don't show the scanner prop (Useful for scanners already on the map).
    },
    {
        location = vec3(1843.4410, 2585.8452, 46.0144),
        heading = 269.8229,
        hideObject = true, -- Don't show the scanner prop (Useful for scanners already on the map).
    },
    {
        location = vec3(2509.005, -420.1887, 94.58201),
        heading = 41.25109,
        hideObject = true, -- Don't show the scanner prop (Useful for scanners already on the map).
    },
    {
        location = vec3(2506.371, -422.4548, 94.58201),
        heading = 221.0215,
        hideObject = true, -- Don't show the scanner prop (Useful for scanners already on the map).
    },
}
